...
export declare const validateStreet: (value: string) => string | null;
export declare const validateCity: (value: string) => string | null;
export declare const validatePostalCode: (value: string) => string | null;
export declare const validateCountry: (value: string) => string | null;
