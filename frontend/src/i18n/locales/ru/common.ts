...
export const ruCommon = {
  ...
  catalogFilters: {
    ...
    colors: "Цвета",
    sizes: "Размеры",
    equipmentType: "Вид спорта / назначение",
  ...
  about: {
    breadcrumb: "О нас",
    title: "Наша команда",
    description: "Люди, стоящие за Sport Gear, и работа, благодаря которой появился этот магазин.",
    contributions: "Вклад {{name}}",
    githubProfile: "Открыть GitHub-профиль {{name}}",
    github: "GitHub",
    leadRole: "Руководитель команды и Full-Stack разработчик",
    leadArchitecture: "Спроектировал архитектуру фронтенда и бекенда",
    leadWorkflow: "Руководил процессом и проверял pull request",
    leadIntegration: "Решал сложные интеграционные задачи",
    nataliaRole: "Full-Stack разработчик",
    nataliaPages: "Создавала страницы приложения и маршрутизацию",
    nataliaResponsive: "Реализовала адаптивные интерфейсы",
    nataliaApis: "Подключила функции фронтенда к API бекенда",
    olhaRole: "Frontend-разработчик и QA",
    olhaComponents: "Разрабатывала переиспользуемые UI-компоненты",
    olhaAccessibility: "Улучшала доступность и пользовательский опыт",
    olhaTesting: "Тестировала ключевые пользовательские сценарии и качество приложения",
  },
  notFound: {
    title: "Такой страницы не существует",
    description: "Мы не нашли нужную страницу. Изучите экипировку и найдите следующую цель.",
    backHome: "На главную",
    browseGear: "Перейти к экипировке",
  },
