...
export const deCommon = {
  ...
  about: {
    breadcrumb: "Über uns",
    title: "Unser Team",
    description: "Die Menschen hinter Sport Gear und die Arbeit, die diesen Shop zum Leben erweckt hat.",
    contributions: "Beiträge von {{name}}",
    githubProfile: "GitHub-Profil von {{name}} ansehen",
    github: "GitHub",
    leadRole: "Teamleitung & Full-Stack-Entwicklung",
    leadArchitecture: "Frontend- und Backend-Architektur entworfen",
    leadWorkflow: "Arbeitsabläufe geleitet und Pull Requests geprüft",
    leadIntegration: "Komplexe Integrationsprobleme gelöst",
    nataliaRole: "Full-Stack-Entwicklung",
    nataliaPages: "Anwendungsseiten und Routing entwickelt",
    nataliaResponsive: "Responsive Benutzeroberflächen umgesetzt",
    nataliaApis: "Frontend-Funktionen mit Backend-APIs verbunden",
    olhaRole: "Frontend-Entwicklung & QA",
    olhaComponents: "Wiederverwendbare UI-Komponenten entwickelt",
